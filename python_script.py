...
# Lambda details
LAMBDA_FUNCTION_NAME = "serverless-app"  # Replace with your actual Lambda function name
...
def upload_to_s3():
    ...
    try:
        ...
        # Invoke Lambda function after successful upload
        invoke_lambda()
...
def invoke_lambda():
    try:
        ...
        response = lambda_client.invoke(
            ...
            InvocationType="Event",  # Use "RequestResponse" if you need the response synchronously
            Payload=str(payload)
        )
